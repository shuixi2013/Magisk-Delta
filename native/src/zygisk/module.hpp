...
enum : uint32_t {
    ...
    MAGISKHIDE_ENABLED = (1u << 28),
    PROCESS_ON_ALLOWLIST = (1u << 26),

    UNMOUNT_MASK = (PROCESS_ON_DENYLIST | MAGISKHIDE_ENABLED),
    PRIVATE_MASK = (MAGISKHIDE_ENABLED | PROCESS_IS_MAGISK_APP)
};
